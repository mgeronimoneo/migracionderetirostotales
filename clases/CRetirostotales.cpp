								...
								if (objMarca.Exec(cSql))
								{
									...
									if (objMarca.leer())
									{
										...
										else if (iCodigo != 0)
										{
												...
												iCodigoMotivo == 1059 || iCodigoMotivo == 2039 || iCodigoMotivo == 2016 || iCodigoMotivo == 2017 || iCodigoMotivo == 2019 || iCodigoMotivo == 2037 || iCodigoMotivo == 2038)
											{
												...
												snprintf(cSql, sizeof(cSql), "update retirostotalesimss set estadosolicitud = 20, entidad = 1, codrechazoent = 66, rechazocod = %i, migracionrettotsafre = 3 "
																			 "where foliosolicitud = %i ",
														 iCodigo, objInfoGen.iFolioServicio);
												objFG.fnSqlEjecutarScrip(odbcServiciosAfore, cSql, cTextoaux);
											}
											/*0521*/ /*TOTALES ISSSTE*/
										...
										snprintf(cSql, sizeof(cSql), "SELECT TRIM(COALESCE(fechamarca,''))::char(10) AS fechamarca, "
																	 ...
																	 "FROM fnrettotfechahoramarca('%s',%ld);",
												 cNss, iConsecutivo);
							...
							if (bPuedeMigrar == true)
							{
								...
								*/
								...
								/*if (objInfoGen.iCodigoMotivo == 2016 || objInfoGen.iCodigoMotivo == 2017 || objInfoGen.iCodigoMotivo == 2019 || objInfoGen.iCodigoMotivo == 2037
									|| objInfoGen.iCodigoMotivo == 2038 || objInfoGen.iCodigoMotivo == 2039)*/
								// CONDICIONES PARA 238
								if (
								...
								if (objInfoGen.iCodigoMotivo == 851 || objInfoGen.iCodigoMotivo == 852 || objInfoGen.iCodigoMotivo == 853 || objInfoGen.iCodigoMotivo == 854 || objInfoGen.iCodigoMotivo == 855 || objInfoGen.iCodigoMotivo == 858 || objInfoGen.iCodigoMotivo == 863 ||
								...
								if (
									...
									iCodigoMotivo == 2017 || iCodigoMotivo == 2037 || iCodigoMotivo == 2038) // CONDICIONES PARA EL 1979 -> 1029,1030,1031,1052,1059,2017,2037,2038,2039
								{
